...
<html lang="en">
    ...
    <body id="bg">
        <div class="page-wraper">
            ...
            <!--TOAST-->
            <div id="failtoast">Email or phone number existed!</div>
            ...
            <div class="account-form">
                ...
                <div class="account-form-inner">
                    <div class="account-container">
                        ...
                        <form id="registerForm" class="contact-bx needs-validation" novalidate>
        ...
        <script >
            $("#registerForm").submit(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "register", // Use the URL of your AddUserServlet
                    data: formData,

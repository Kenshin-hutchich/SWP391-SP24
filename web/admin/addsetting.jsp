            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/asettingaddcontrol" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"   placeholder="name" id="input-1" name="s-name">
                            </div>

                            <div class="form-group">
                               <label for="input-1">Value</label>
                                <input type="text" class="form-control" placeholder="value"    id="input-1" name="s-value">
                            </div>

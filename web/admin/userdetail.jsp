            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/auserupdatecontrol" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-1" readonly value="${c.id} " name="user-id">
                            </div>
                            <div class="form-group">
                                <label for="input-1">Avatar</label>
                                <input type="text" class="form-control"   value="${c.avatar} " id="input-1" name="user-avatar">
                            </div>

                            <div class="form-group">
                               <label for="input-1">Email</label>
                                <input type="text" class="form-control" readonly value="${c.email} " id="input-1" name="user-email">
                            </div>
                            <div class="form-group">
                               <label for="input-1">Hash</label>
                                <input type="text" class="form-control" value="${c.hash}"  id="input-1" name="user-hash">
                            </div>
                            <div class="form-group">
                               <label for="input-1">Name</label>
                                <input type="text" class="form-control"  value="${c.name}"  id="input-1" name="user-name">
                            </div>
                            <div class="form-group">
                               <label for="input-1">Mobile</label>
                                <input type="text" class="form-control"  value="${c.mobile}"  id="input-1" name="user-mobile">
                            </div>
                            <div class="form-group">
                               <label for="input-1">Role</label>
                                <input type="text" class="form-control" value="${c.roleSetting.value} " id="input-1" name="user-role">
                            </div>

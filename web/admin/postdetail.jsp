            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/postupdatecontrol" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-1" readonly value="${c.id} " name="post-id">
                            </div>
                            <div class="form-group">
                                <label for="input-1">AuthorID</label>
                                <input type="text" class="form-control"  readonly value="${c.author.id} " id="input-1" name="post-authorid">
                            </div>

                            <div class="form-group">
                               <label for="input-1">Thumbnail</label>
                                <input type="text" class="form-control" value="${c.thumbnail} " id="input-1" name="post-thumbnail">
                            </div>
                            <div class="form-group">
                               <label for="input-1">title</label>
                                <input type="text" class="form-control" value="${c.title}"  id="input-1" name="post-title">
                            </div>
                            <div class="form-group">
                               <label for="input-1">BriefInfo</label>
                                <input type="text" class="form-control"  value="${c.briefInfo}"  id="input-1" name="post-briefinfo">
                            </div>
                            <div class="form-group">
                               <label  class="col-form-label">Description</label>
                                <div>
                                   
                                    <textarea class="form-control" id="content-product" value="${c.description}" name="post-description" >${c.description}</textarea>
                           ...
                           <div class="form-group">
                                <label for="input-2">Featured</label>
                                <div>
                                    <select class="form-control valid" id="input-6" name="post-featured"  aria-invalid="false">
                                        
                                        <c:if test="${c.featured==true}">
                                            <option value="true">on</option>
                                            <option value="false">off</option>
                                            
                                        </c:if>
                                            <c:if test="${c.featured==false}">
                                            <option value="false">off</option>
                                             <option value="true">on</option>
                                        </c:if>
                          ...
                          <div class="form-group">
                                ...
                                <div>
                                    <select class="form-control valid" id="input-6" name="post-status" aria-invalid="false">
                            ...
                            <div class="form-footer">
                                ...
                                <button type="submit" class="btn btn-success"><i class="fa fa-check-square-o"></i> Save</button>
                                    ...
                                    <button class="btn btn-danger"><i class="fa fa-times"></i><a href="${pageContext.request.contextPath}/postcontrol">Cancel</a></button>

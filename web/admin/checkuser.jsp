...
<html lang="en">
    ...
    <body class="ttr-opened-sidebar ttr-pinned-sidebar">
        ...
        <main class="ttr-wrapper">
           ...
           <input type="checkbox" name="status" ${ci2[3]?"checked":""} value="1" onclick="this.form.submit()"/>Deactive   
                                ...
                                <div class="table-responsive">
                                            ...
                                            <c:forEach items="${data}" var="u">
                                                <c:set var="id" value="${u.id}">  </c:set>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <td><img style="    width: 67px;height: 67px; object-fit: cover;border: 1px solid #fff;" src="${pageContext.request.contextPath}/admin/assets/images/testimonials/${u.avatar}" ></td>
                                                    <td>${u.email}</td>
                                                    <td>${u.hash}</td>
                                                    <td>${u.name }</td>
                                                    <td>${u.mobile }</td>
                                    ...
                                    <div class="pagination">
                                        <c:forEach begin="1" end="${requestScope.num}" var="i">
                                            <a class="${i==page?"active":""}" href="${pageContext.request.contextPath}/ausercontrol?page=${i}">${i}</a>

            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/slideraddcontrol" method="POST">
                            ...
                            <!--<div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-1"  placeholder="ID" name="s-id">
                            </div>-->
                            <div class="form-group">
                                <label for="input-1">Title</label>
                                <input type="text" class="form-control" placeholder="Title" id="input-1" name="s-title">
                            </div>

                            <div class="form-group">
                               <label for="input-1">Image</label>
                                <input type="text" class="form-control" placeholder="Image" id="input-1" name="s-image">
                            </div>
                            <div class="form-group">
                               <label for="input-1">Backlink</label>
                                <input type="text" class="form-control" placeholder="Backlink" id="input-1" name="s-backlink">
                            </div>
                                       <div class="form-group">
                                <label for="input-2">Status</label>
                                <div>
                                    <select  class="form-control valid" id="input-6" name="s-status" >

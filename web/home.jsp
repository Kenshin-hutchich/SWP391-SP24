            ...
            <jsp:include page="common-header.jsp"></jsp:include>
                <script>
                    $(document).ready(function () {
                        $('.header.rs-nav').addClass('header-transparent');
                        $('img[src="assets/images/logo.png"]').attr('src', 'assets/images/logo-white.png');
                    });
                </script>
                <!-- Header Top END ==== -->
                <!-- Content -->
                                ...
                                <ul>	<!-- SLIDE  -->
                                    <li data-index="rs-100" 
                                        ...
                                        <div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
                                            ...
                                            Explore a vast array of free online courses covering diverse topics on our platform, empowering learners worldwide to expand their knowledge and skills.
                                        </div>
                                        <!-- LAYER NR. 4 -->
                                    </li>
                                        ...
                                        <div class="item">
                                            <div class="cours-bx">
                                                <div class="action-box">
                                                    ...
                                                    <a href="course-details?id=${course.id}" class="btn">Read More</a>
                                                </div>
                                                <div class="info-bx text-center">
                                                    <h5><a href="course-details?id=${course.id}">${course.title}</a></h5>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 text-center text-white">
                                    ...
                                    <form class="cours-search" action="courses" method="get">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="courseName" placeholder="What do you want to learn today?	">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="cours-search-bx m-b30">
                                            <div class="icon-box">
                                                <h3><i class="ti-user"></i><span class="counter">${userCount}</span>${userCountUnit}</h3>
                                            </div>
                                            <span class="cours-search-text">Over ${userCount} ${userCountUnit} student</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="cours-search-bx m-b30">
                                            <div class="icon-box">
                                                <h3><i class="ti-book"></i><span class="counter">${courseCount}</span>${courseCountUnit}</h3>
                                            </div>
                                            <span class="cours-search-text">${courseCount}${courseCountUnit} Courses.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="recent-news">
                                            ...
                                            <div class="info-bx">
                                                <ul class="media-post">
                                                    ...
                                                    <li><a href="#"><i class="fa fa-user"></i>By ${post.author.name}</a></li>
                                                </ul>
                                                <h5 class="post-title"><a href="blog-details">${post.title}</a></h5>
                                                <p>${post.briefInfo}</p>
                                                <div class="post-extra">
                                                    <a href="#" class="btn-link">READ MORE</a>
                                                    <a href="#" class="comments-bx"><i class="fa fa-comments-o"></i>${post.numberOfComment} Comment</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

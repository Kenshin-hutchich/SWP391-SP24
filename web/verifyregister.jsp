...
<html lang="en">
    ...
    <body id="bg">
                ...
                <div class="account-form-inner">
                    <div class="account-container">
                        ...
                        <div class="container">
                            ...
                            <form id="verifyRe" action="usercontroller" method="post">
                                <input type="hidden"  name="action" value="verify">
                                <input type="text" id="code" name="code" placeholder="Enter your 6-digit code sent in email">
        ...
        <script>
            // JavaScript code
            document.getElementById('verifyRe').addEventListener('submit', function (e) {
        ...
        <script>
            $("#verifyRe").submit(function (event) {
                event.preventDefault(); // Prevent the default form submission
                var formData = $(this).serialize();
                $.ajax({
                    type: "GET",
                    url: "usercontroller?action=verify", // Use the URL of your AddUserServlet
                    data: formData,
